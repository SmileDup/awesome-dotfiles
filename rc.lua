...
awful.layout.layouts = {awful.layout.suit.spiral.dwindle, -- awful.layout.suit.spiral,
awful.layout.suit.tile, awful.layout.suit.floating -- awful.layout.suit.tile.left,
...
}, -- Floating clients.
{
    rule_any = {
        ...
        "Wpa_gui", "veromix", "xtightvncviewer", "Virt-manager", "virt-manager"},
